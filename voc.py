...
def get_voc2007_train(image_size,_mean,_std):
    ...
    return Voc2007Classification("voc2007","trainval",tr)
def get_voc2007_test(image_size,_mean,_std):
    tr=transforms.Compose([
                Warp(image_size),
                transforms.ToTensor(),
                transforms.Normalize(mean=_mean,
    ...
    return Voc2007Classification("voc2007","test",tr)
